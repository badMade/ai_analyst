...
class TestRunInteractive:
    ...
    def test_displays_welcome_panel(
        self, mock_console, mock_prompt, mock_analyst_class, mock_settings_valid, mock_setup_logging
    ):
    ...
    def test_quit_command_exits(
        ...
        goodbye_printed = any(
            "goodbye" in str(call).lower() for call in mock_console.print.call_args_list
        )
    ...
    def test_help_command_shows_help(
        ...
        help_printed = any(
            "commands" in str(call).lower() for call in mock_console.print.call_args_list
        )
        assert help_printed
    ...
    def test_load_command_loads_file(
        ...
        loaded_printed = any(
            "loaded" in str(call).lower() for call in mock_console.print.call_args_list
        )
    ...
    def test_load_command_handles_missing_file(
        ...
        error_printed = any(
            "not found" in str(call).lower() for call in mock_console.print.call_args_list
        )
    ...
    def test_shows_analyzing_message(
        ...
        analyzing_printed = any(
            "analyzing" in str(call).lower() for call in mock_console.print.call_args_list
        )
    ...
    def test_handles_keyboard_interrupt(
        ...
        quit_message = any(
            "quit" in str(call).lower() for call in mock_console.print.call_args_list
        )
        assert quit_message
    ...
    def test_handles_exception(
        ...
        error_printed = any(
            "error" in str(call).lower() for call in mock_console.print.call_args_list
        )
        assert error_printed
