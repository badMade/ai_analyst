        ...
        try:
            if tool_name == "load_dataset":
                ...
                result = {
                    ...
                    "statistic": round(test_result.statistic, 4) if not pd.isna(test_result.statistic) else None,
                    "p_value": round(test_result.p_value, 4) if not pd.isna(test_result.p_value) else None,
