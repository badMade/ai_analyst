...
class AnalysisContext:
    ...
    def get_dataset(self, name: str) -> pd.DataFrame:
        ...
        if name not in self.datasets:
            raise ValueError(
                f"Dataset '{name}' not loaded. Available: {list(self.datasets.keys())}"
            )
...
TOOLS = [
    ...
    },
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "dataset_name": {"type": "string", "description": "Name of the loaded dataset"},
                "n_rows": {
                    "type": "integer",
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "dataset_name": {"type": "string", "description": "Name of the loaded dataset"},
                "column": {"type": "string", "description": "Column to analyze for outliers"},
                "method": {
                    "type": "string",
                    "enum": ["iqr", "zscore"],
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "dataset_name": {"type": "string", "description": "Name of the loaded dataset"},
                "column": {"type": "string", "description": "Column to analyze for trends"},
            },
            "required": ["dataset_name", "column"],
        },
    },
    ...
    def _execute_tool(self, tool_name: str, tool_input: dict) -> str:
        ...
        try:
            if tool_name == "load_dataset":
                result = self.context.load_dataset(tool_input["file_path"], tool_input.get("name"))
                ...
                for col in numeric_df.columns:
                    stats.append({"column": col, **compute_descriptive_stats(numeric_df[col])})
                ...
                agg_functions = tool_input.get(
                    "agg_functions", ["count", "mean", "sum", "min", "max"]
                )
                ...
                duplicate_percentage = (duplicate_rows / total_rows) * 100 if total_rows else 0.0
